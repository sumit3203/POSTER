...
The Active Segmentation  is a ImageJ plugin inspired by trainable Weka Segmentation.
	\newline
	\newline
  \begin{minipage}{.20\textwidth}
  	...
  	\newline
  	\newline
  	\includegraphics[width=4.5cm,height=5cm]{astrocyte}	
  	\newline
  \end{minipage}
  	\begin{minipage}{.10\textwidth}
  ...
  \headerbox{Conclusions \& Outlook}{name=conclusion,column=2,span=1,below=baseline}{
  	...
  	\begin{itemize}
  		\item \color{primary1}\textbf{Semi Supervised: } The results can be refined with iterations.
